...
//        cfg.setProperty("hibernate.format sql", String.valueOf(true));
//        cfg.setProperty("hibernate.use sql comments", String.valueOf(true));
//        cfg.setProperty("hibernate.show_sql", String.valueOf(true));
